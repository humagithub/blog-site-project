...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4 text-primary"><i class="fas fa-file-alt"></i> Show Admin Posts</h1>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('admin.posts.create') }}" class="btn btn-lg btn-success">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <i class="fas fa-table me-1"></i> Posts List
                </div>
                <div class="card-body">
